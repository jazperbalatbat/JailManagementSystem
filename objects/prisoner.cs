...
namespace JailManagementSystem.objects
{
    class prisoner
    {
        ...
        public object dgv_prisoner { get; set; }
        ...
        public prisoner(int id)
        {
            ...
            con.Adaptor("select * from prisoner where id=" + id.ToString());
        ...
        public void search()
        {
            ...
            cmd.CommandText = "select * from prisoner where firstname ='" + this.searchdb + "' OR lastname = '" + this.searchdb + "' OR middlename = '" + this.searchdb + "' OR address = '" + this.searchdb + "' OR age = '" + this.searchdb + "' OR gender = '" + this.searchdb + "' OR height = '" + this.searchdb + "' OR weight = '" + this.searchdb + "' OR citizenship = '" + this.searchdb + "' OR religion = '" + this.searchdb + "' OR civilstatus = '" + this.searchdb + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            dgv_prisoner = dt.DefaultView;
            
        }

       

        public void refreshTB_prisoner()
        {
            lastname = null;
            firstname = null;
            middlename = null;
